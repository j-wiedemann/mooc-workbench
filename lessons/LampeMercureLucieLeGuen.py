...
def MakeDataTutorial():
    ...
    step["video"] = 'https://open.tube/videos/embed/579d5229-f1a8-426b-80ad-ec4ef1aa0a87?start=0m00s'
    ...
    step["description"] = u'''<h3>Une oreille.</h3>
        ...
        <li>Créer une nouvelle esquisse sur le paln YZ</li>
    ...
    step["description"] = u'''<h3>Oreille par symétrie</h3>
        <p>Pour faire l'oreille de l'autre coté, rien de plus facile que

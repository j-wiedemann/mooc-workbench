...
class lesson(object):
    def __init__(self):
        ...
        self.data_tutorial = {}
        self.data_tutorial["title"] = u'[FR] MOOC Semaine 2 - Korrigans de Valérian Henry'
...
de matière.'''
        ...
        step["objectives"] = [u"1 esquisse (Sketch) sur le plan XZ.",]
        ...
        step["objectives"] = [u"1 contour fermé de 5 segments. (cliquer sur le bouton Mettre à jour dans l'onglet Tâches pour vérifier cet objectif)",
        u"5 contraintes de coïncidence.",
        u"2 contraintes d'orientation verticales.",
        ...
        step["objectives"] = [u"1 contrainte de dimension verticale de 150mm.", "1 contrainte de dimension horizontale de 55 mm.", "1 contrainte de valeure angulaire de 55°." ]
        ...
        step["objectives"] = [u"1 esquisse (Sketch001) sur le plan YZ.", u"1 contour fermé à 3 côtés.", u"2 arêtes externes."]
        ...
        step["objectives"] = ["1 cavité (Pocket), à travers tout, symétrique au plan."]
        ...
        # Step 12
        step = {}
        step["description"] = u'''<h3>Faire l'espace entre les jambes</h3>
        ...
        step["objectives"] = ["1 répétition par symétrie (Mirrored001)."]
        ...
        step["objectives"] = [u"Sauvegardé le document sous le nom Korrigans."]
